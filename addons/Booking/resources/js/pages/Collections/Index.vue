<template>
    <div class="collection-page">
        ...
        <portal to="actions">
            <ui-button v-if="collection.slug" variant="primary" :to="{ name: 'bookable_collection.create', params: {collection: collection.slug} }">Create</ui-button>
        </portal>
                ...
                >
                    <template slot="name" slot-scope="table">
                        <div class="flex items-center">
                            ...
                            <router-link :to="{ name: 'bookable_collection.booking.index', params: {collection: collection.slug, id: table.record.id} }">{{ table.record.name }}</router-link>
                        </div>
                    </template>
                    ...
                    <template slot="actions" slot-scope="table">
                        <ui-actions :id="'entry_' + table.record.id + '_actions'" :key="'entry_' + table.record.id + '_actions'">
                            <ui-dropdown-link :to="{ name: 'bookable_collection.booking.create', params: {collection: collection.slug, id: table.record.id} }">New Booking</ui-dropdown-link>
                            ...
                            <ui-dropdown-link :to="{ name: 'bookable_collection.booking.index', params: {collection: collection.slug, id: table.record.id} }">Manage Bookings</ui-dropdown-link>
