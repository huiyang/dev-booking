...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Addons\Booking\Http\Controllers';
    ...
    protected function mapWebRoutes()
    {
        Route::group([
            ...
            require base_path('addons/Booking/routes/web.php');
        });
    }
    ...
    protected function mapApiRoutes()
    {
        Route::group([
            ...
            require base_path('addons/Booking/routes/api.php');
        });
    }
    ...
    protected function mapDataTableRoutes()
    {
        Route::group([
            ...
            require base_path('addons/Booking/routes/datatable.php');
        });
    }
}